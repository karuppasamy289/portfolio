createPath('scratch');
  function createPath(type){
    ...
    if(type=="scratch"){
      ...
      for(let d=0;d<bid;d++){
        document.getElementById(bid[d]).style.background="none";
      }
      console.log("scratch");
